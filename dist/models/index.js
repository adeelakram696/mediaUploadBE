...
var env = 'development';
var dbConfig = _config["default"][env];
var sequelize = new _sequelize["default"](dbConfig.database, dbConfig.username, dbConfig.password, _objectSpread(_objectSpread({}, dbConfig), {}, {
  dialectOptions: {
    ssl: {
      require: true,
